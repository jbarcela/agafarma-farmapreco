            ...
            <div className={styles.headerSecondary}>
                ...
                <nav>
                    <ul className={styles.navUl}>
                        ...
                        <li className={styles.navUlLi}><a title='Click aqui para ir para o facebook' href="" className={styles.link}><img src="/images/icons/facebook.png" alt="Icone do facebook" /></a></li>
                        <li className={styles.navUlLi}><a title='Click aqui para ir para o instagram' href="" className={styles.link}><img src="/images/icons/insta.png" alt="Icone do instagram" /></a></li>
                        <li className={styles.navUlLi}><a title='Click aqui para ir para o whatsapp' href="" className={styles.link}><img src="/images/icons/whats.png" alt="Icone do whatsapp" /></a></li>
                    </ul>
                </nav>
            </div>
        </div>
